...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--check-interval", type=int, default=60, help="Seconds between health checks (default: 60)")

    def handle(self, *args, **options):
        check_interval = options["check_interval"]

        self.stdout.write(f"Starting foreman with {check_interval}s check interval")
        ...
        self.stdout.write(self.style.SUCCESS("Foreman stopped"))
