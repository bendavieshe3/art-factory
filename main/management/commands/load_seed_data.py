...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options["reset"]:
            self.stdout.write(self.style.WARNING("Deleting existing factory machines and instances..."))
        ...
        try:
            with transaction.atomic():
                        ...
                        "parameter_schema": {
                            ...
                            "properties": {
                                ...
                                "enable_safety_checker": {
                                    "type": "boolean",
                                    "default": False,
                                    "description": "Enable the safety checker (disabled by default)",
                                },
                            },
                            "required": ["prompt"],
                        },
                        ...
                        "parameter_schema": {
                            ...
                            "properties": {
                                ...
                                "disable_safety_checker": {
                                    "type": "boolean",
                                    "default": True,
                                    "description": "Disable the safety checker (disabled by default)",
                                },
                            },
                            "required": ["prompt"],
                        },
                ...
                for machine_data in machines_data:
                    machine, created = FactoryMachineDefinition.objects.get_or_create(
                        name=machine_data["name"], defaults=machine_data
                    )
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"\nSuccessfully loaded {machine_count} factory machine definitions " f"and {instance_count} instances"
                )
            )
