...
class BulkOperationsViewTestCase(TestCase):
    ...
    def test_bulk_delete_success_ajax(self):
        ...
        response = self.client.post(
            reverse("main:bulk_delete_products"), data={"product_ids": product_ids}, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
    ...
    def test_bulk_delete_success_non_ajax(self):
        ...
        response = self.client.post(reverse("main:bulk_delete_products"), data={"product_ids": product_ids})
    ...
    def test_bulk_delete_no_products_selected_ajax(self):
        ...
        response = self.client.post(
            reverse("main:bulk_delete_products"), data={"product_ids": []}, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
    ...
    def test_bulk_delete_error_handling_ajax(self):
        ...
        with patch.object(Product.objects, "filter") as mock_filter:
            ...
            response = self.client.post(
                reverse("main:bulk_delete_products"), data={"product_ids": ["1", "2"]}, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
            )
    ...
    def test_bulk_download_success(self, mock_storage):
        ...
        response = self.client.post(reverse("main:bulk_download_products"), data={"product_ids": product_ids})
    ...
    def test_bulk_download_no_products_selected(self):
        ...
        response = self.client.post(reverse("main:bulk_download_products"), data={"product_ids": []})
...
class UnifiedComponentIntegrationTestCase(TestCase):
    ...
    def test_ajax_vs_non_ajax_behavior_consistency(self):
        ...
        non_ajax_response = self.client.post(
            reverse("main:bulk_delete_products"), data={"product_ids": [str(self.products[1].id)]}
        )
