...
class BootstrapIntegrationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.factory_machine = FactoryMachineDefinition.objects.create(
            ...
            modality="image",
            parameter_schema={"width": 1024, "height": 1024, "steps": 25, "guidance": 7.5},
            default_parameters={"width": 1024, "height": 1024, "steps": 25, "guidance": 7.5, "enable_safety_checker": False},
            is_active=True,
        )
