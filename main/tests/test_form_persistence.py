...
class FormPersistenceTestCase(TestCase):
    ...
    def test_form_persistence_initialization_sequence(self):
        ...
        self.assertLess(load_page_data_pos, load_form_values_pos, 
                       "loadPageData should be called before loadFormValues")
        self.assertLess(load_form_values_pos, form_submit_pos,
