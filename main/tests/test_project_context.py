...
class ProjectContextTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.active_project = Project.objects.create(
            name="Active Test Project", description="An active project for testing", status="active"
        )

        self.inactive_project = Project.objects.create(
            name="Inactive Test Project", description="An inactive project for testing", status="archived"
        )
...
class GetCurrentProjectTestCase(ProjectContextTestCase):
    ...
    def test_get_current_project_with_valid_session(self):
        ...
        request = self._create_request_with_session(**{PROJECT_CONTEXT_SESSION_KEY: self.active_project.id})
    ...
    def test_get_current_project_nonexistent_id(self):
        ...
        request = self._create_request_with_session(**{PROJECT_CONTEXT_SESSION_KEY: 99999})
    ...
    def test_get_current_project_inactive_project(self):
        ...
        request = self._create_request_with_session(**{PROJECT_CONTEXT_SESSION_KEY: self.inactive_project.id})
    ...
    def test_get_current_project_invalid_id_format(self):
        ...
        request = self._create_request_with_session(**{PROJECT_CONTEXT_SESSION_KEY: "invalid_id"})
...
class EnsureProjectContextTestCase(ProjectContextTestCase):
    ...
    def test_ensure_project_param_takes_priority(self):
        ...
        other_project = Project.objects.create(name="Other Project", description="Another project", status="active")
...
class ProjectContextIntegrationTestCase(ProjectContextTestCase):
    ...
    def test_project_context_persistence_across_requests(self):
        ...
        request2 = self._create_request_with_session(**{PROJECT_CONTEXT_SESSION_KEY: self.active_project.id})
