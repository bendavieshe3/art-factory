...
class FactoryMachineDefinition(models.Model):
    ...
    parameter_schema = models.JSONField(
        default=dict, 
        help_text="JSON schema defining available parameters"
    )
    ...
    cost_per_operation = models.DecimalField(
        ...
        null=True, 
        blank=True,
        help_text="Estimated cost per generation"
    )
...
class FactoryMachineInstance(models.Model):
    ...
    # Current operation
    current_operation = models.JSONField(
        null=True, 
        blank=True,
        help_text="Details of current operation if busy"
    )
    current_order_item = models.ForeignKey(
        ...
        null=True, 
        blank=True,
        help_text="Currently processing order item"
    )
