"""
Django settings for ai_art_factory project.
...
SECRET_KEY = config("SECRET_KEY", default="django-insecure-5vdy**+7d07rq^oham&20mgg-8o&jaw$^l#ca%guwcv+n2(^a@")
...
ROOT_URLCONF = "ai_art_factory.urls"
...
WSGI_APPLICATION = "ai_art_factory.wsgi.application"
...
# Media files (user uploads and generated products)
MEDIA_URL = "/media/"
